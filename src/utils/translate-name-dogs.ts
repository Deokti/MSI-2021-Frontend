function translate(name: string) {
  switch (name) {
    case "Все породы": { return 'Все породы' }
    case "Affenpinscher": { return 'Аффенпинчер' }
    ...
    case "Alaskan Malamute": { return 'Аляскинский маламут' }
    ...
    case "American Water Spaniel": { return 'Американский водяной спаниель' }
    case "Anatolian Shepherd Dog": { return 'Анатолийская овчарка' }
    case "Appenzeller Sennenhund": { return 'Аппенцелльский зенненхунд' }
    case "Australian Cattle Dog": { return 'Австралийская пастушья собака' }
    case "Australian Kelpie": { return 'Австралийский келпи' }
    case "Australian Shepherd": { return 'Австралийская овчарка' }
    case "Australian Terrier": { return 'Австралийский терьер' }
    case "Azawakh": { return 'Азавак' }
    case "Barbet": { return 'Барбет' }
    case "Basenji": { return 'Басенджи' }
    case "Basset Bleu de Gascogne": { return 'Голубой гасконский бассет' }
    case "Basset Hound": { return 'Бассет-хаунд' }
    case "Beagle": { return 'Бигль' }
    case "Bearded Collie": { return 'Бородатый колли' }
    case "Beauceron": { return 'Босерон' }
    case "Bedlington Terrier": { return 'Бедлингтон терьер' }
    case "Belgian Malinois": { return 'Бельгийский малинуа' }
    case "Belgian Tervuren": { return 'Бельгийский Тервюрен' }
...
export function translateNameDogs(name: string) {
